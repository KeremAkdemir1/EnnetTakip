...
<View style={{ top: 50, backgroundColor: '#67C5B5', width: Dimensions.get('screen').width - 50,height: Dimensions.get('screen').width > 500 ? 80 : 70, borderTopRightRadius: 30, borderBottomLeftRadius: 30, alignContent: 'center', alignItems: 'center' }}>
                <Text style={styles.topText}>
                    {I18n.t('tümOperasyonlar')}
...
export default TumOperasyonlar