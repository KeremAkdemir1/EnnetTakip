...
const BekleyenSiparisler = () => {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{ top: 100, backgroundColor: '#FECB10', width: Dimensions.get('screen').width - 50, height: Dimensions.get('screen').width > 500 ? 90 : 70, borderTopRightRadius: 30, borderBottomLeftRadius: 30, alignContent: 'center', alignItems: 'center' }}>
                <Text style={styles.topText}>
                    {I18n.t('bekleyenSiparisler')}
            ...
            <View style={{ top: 140, width: Dimensions.get('screen').width - 50, alignContent: 'center', justifyContent: 'center', flexDirection: 'row' }}>
                <Pressable style={{
