...
const UrunListesi1 = () => {
    ...
    return (
        <ScrollView>
            ...
            <View>
                <View style={{backgroundColor:'#67C5B5',marginRight:17,marginLeft:17,height:50,borderRadius:10}}>
                    <Text style={{color:'#FFF',fontFamily:'Poppins',marginLeft:10,marginTop:13,fontSize: Dimensions.get('screen').width > 500 ? 18 : 14}}>Fiyat Güncelleme</Text>
                </View>
                <View style={{height:20}}/>
                <View style={{ justifyContent: 'space-between', flexDirection: 'row',left:15 }}>
                    <View style={{ flex: 2 }}>
                        <TextInput placeholder="10 TL" style={{ fontSize: Dimensions.get('screen').width > 500 ? 18 : 14,borderTopWidth: 2, borderLeftWidth: 2, borderRightWidth: 2, borderBottomWidth: 2, borderColor: '#CCCCCC', height: 40, borderRadius: 10, fontFamily: 'Poppins', paddingLeft: 10, color: '#9A9A9A' }} />

                    </View>
                    <View style={{ width: 50 }} />
                    <View style={{ flex: 2, right: 30 }}>
                        <TextInput placeholder="TL Oranı Zam Yap" style={{ fontSize: Dimensions.get('screen').width > 500 ? 18 : 14,borderTopWidth: 2, borderLeftWidth: 2, borderRightWidth: 2, borderBottomWidth: 2, borderColor: '#CCCCCC', height: 40, borderRadius: 10, fontFamily: 'Poppins', paddingLeft: 10, color: '#9A9A9A' }} />
                    </View>
                </View>
                <View style={{height:20}}/>
                <View style={{ justifyContent: 'space-between', flexDirection: 'row',left:15 }}>
                    <View style={{ flex: 2 }}>
                        <Pressable style={{ height: 40, borderRadius: 10, fontFamily: 'Poppins', paddingLeft: 10,backgroundColor:'#E1E1E1' }}><Text style={{textAlign:'center',marginTop:8,marginRight:9,color:'#FFF',fontSize:Dimensions.get('screen').width > 500 ? 18 : 14}}>Tümünü Seç</Text></Pressable>

                    </View>
                    <View style={{ width: 50 }} />
                    <View style={{ flex: 2, right: 30 }}>
                    <Pressable onPress={() => selected === false ? setSelected(true) : setSelected(false)} style={{ height: 40, borderRadius: 10, fontFamily: 'Poppins', paddingLeft: 10,backgroundColor:'#E1E1E1' }}><Text style={{textAlign:'center',marginTop:8,marginRight:9,color:'#FFF',fontSize:Dimensions.get('screen').width > 500 ? 18 : 14}}>Seçtiklerim</Text></Pressable>
                    </View>
                </View>
